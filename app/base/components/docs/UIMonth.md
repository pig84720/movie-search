...
kMonth 為 ViewModel 中定義勾選欄位的 ViewModel  
...
<ui-month params="viewModel: kMonth" class="col-xs-12 col-sm-6 col-md-6"></ui-month>
<!--IE8的引用方式-->
<div data-bind='component: {name:"ui-month", params: {viewModel: kMonth}}'
